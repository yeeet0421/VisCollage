...
function sheetContainer(curr_dataset,curr_sheet_num){
    ...
    setAttributes(sheet_container,{"data-dataset":curr_dataset,"id":sheet_container_id,"class":"sheet_container","style":"width:100%;height:95%;overflow:auto;position:relative;"})

    // set explore view
    var exp_container = document.createElement("div")
    setAttributes(exp_container,{"id":"exp_container","style":"float:left;overflow:auto;position:absolute;top:0;zoom: 1; width:12%; height:18%;"})
