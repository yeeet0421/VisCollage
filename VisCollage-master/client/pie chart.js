...
function pie_options(element,data,canvas_id,chart_id,chart_datas){
    ...
    var pie_title_text = "Percentage"
    if(curr_dataset == "Transation"){
        pie_title_text = 'Consumption percentage';
    }else if(curr_dataset == "Netflix"){
        pie_title_text = 'Quantity percentage';
    }
    var options = { 
